...
*/
function PublicKey(Q, pubkey_prefix = 'ROXE') {
    if(typeof Q === 'string') {
    ...
    */
    function toString(pubkey_prefix = 'ROXE') {
...
/**
  ...
  @param {string} [pubkey_prefix = 'ROXE']
*/
PublicKey.isValid = function(pubkey, pubkey_prefix = 'ROXE') {
    try {
...
*/
PublicKey.fromString = function(public_key, pubkey_prefix = 'ROXE') {
    try {
...
/**
    ...
    @return PublicKey
*/
PublicKey.fromStringOrThrow = function(public_key, pubkey_prefix = 'ROXE') {
