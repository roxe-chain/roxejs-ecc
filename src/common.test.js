...
describe('Common API', () => {
  ...
  it('privateToPublic', () => {
    ...
    const pub = 'ROXE859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'
  ...
  it('isValidPublic', () => {
    const keys = [
      ...
      [true, 'ROXE859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'MMM859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM'],
      [false, 'ROXE859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVm', 'ROXE'],
