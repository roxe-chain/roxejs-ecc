...
[![NPM](https://img.shields.io/npm/v/roxejs-ecc.svg)](https://www.npmjs.org/package/roxejs-ecc)
[![Build Status](https://travis-ci.org/ROXE/roxejs-ecc.svg?branch=master)](https://travis-ci.org/ROXE/roxejs-ecc)
...
-   Install with: `yarn add roxejs-ecc`
-   Html script tag, see [releases](https://github.com/roxe-chain/roxejs-ecc/releases) for the correct **version** and its matching script **integrity** hash.
...
<head>
  <meta charset="utf-8">
  <!--
  sha512-cL+IQQaQ586s9DrXfGtDheRpj5iDKh2M+xlpfwbhNjRIp4BGQ1fkM/vB4Ta8mc+f51YBW9sJiPcyMDIreJe6gQ== lib/roxejs-ecc.js
  sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ== lib/roxejs-ecc.min.js
  sha512-eq1SCoSe38uR1UVuQMwR73VgY8qKTBDc87n2nIiC5WLhn1o2y1U6c5wY8lrigVX7INM8fM0PxDlMX5WvpghKig== lib/roxejs-ecc.min.js.map
  -->
  <script src="https://cdn.jsdelivr.net/npm/roxejs-ecc@1.0.0/lib/roxejs-ecc.min.js"
    integrity="sha512-dYFDmK/d9r3/NCp6toLtfkwOjSMRBaEzaGAx1tfRItC0nsI0hVLERk05iNBQR7uDNI7ludYhcBI4vUiFHdjsTQ=="
    crossorigin="anonymous"></script>

</head>
<body>
  See console object: roxejs_ecc
</body>
</html>
```
...
-   `wif` **[wif](#wif)** 
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)** public key prefix (optional, default `'ROXE'`)
...
-   `pubkey` **[pubkey](#pubkey)** like ROXEKey..
-   `pubkey_prefix` **[string](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String)**  (optional, default `'ROXE'`)
...
-   `signature` **([String](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Global_Objects/String) \| [Buffer](https://nodejs.org/api/buffer.html))** (ROXEbase58sig.., Hex, Buffer)
...
```js
let {PrivateKey, PublicKey, Signature, Aes, key_utils, config} = require('roxejs-ecc')
...
```bash
git clone https://github.com/roxe-chain/roxejs-ecc.git
cd roxejs-ecc
yarn
yarn build_browser
# builds: ./dist/roxejs-ecc.js
# Verify release hash
```

```html
<script src=roxejs-ecc.js></script>
```
